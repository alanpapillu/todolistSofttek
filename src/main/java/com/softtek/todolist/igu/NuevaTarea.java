...
public class NuevaTarea extends javax.swing.JFrame {
    ...
    // Creo un objeto que me permita llamar a la lógica desde la interfaz gráfica
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        //Obtengo los datos ingresados en los campos Descripción y Prioridad
        String descripcion = txtDescripcion.getText();
        String prioridad = (String) cmbPrioridad.getSelectedItem();
        
        
        //Valido los datos ingresados para que no haya tareas en blanco
        if (descripcion.isEmpty()){
            JOptionPane.showMessageDialog(null, "Por favor, ingresa datos.", "Advertencia", JOptionPane.WARNING_MESSAGE);
        } else {
            control.agregarTarea(descripcion, prioridad);
        }
        
        mostrarMensaje("Tarea agregada correctamente","Info","Tarea agregada");
